        ...
        <div class="col-lg-8">
            <section class="panel">
                ...
                <div class="panel-body">
                    {!! Form::model($service, ['role' => 'form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'accept' => 'image/*']) !!}
...
<script>
    ...
    $("#image").fileinput({
        showUpload: false,
        initialPreview: ["<img src='{{ url('/').'/files/services/'.$service->image_url }}' class='file-preview-image'>"],
        initialPreviewConfig: [
            {caption: '{{ str_slug($service->name) }}.jpg', width: '120px', url: '#'},
        ],
