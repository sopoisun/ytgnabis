            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list {{ set_active('backend/business/category*', 'nav-active') }}">
                        ...
                        <ul class="child-list">
                            <li class="{{ set_active('backend/business/category/add') }}"><a href="{{ url('/backend/business/category/add') }}"> Tambah Kategori Bisnis</a></li>
                            <li class="{{ set_active('backend/business/category') }}"><a href="{{ url('/backend/business/category') }}"> Daftar Kategori Bisnis</a></li>
                        </ul>
                    </li>
                    <li class="menu-list {{ set_active('backend/business*', 'nav-active') }}">
                        <a href=""><i class="fa fa-suitcase"></i>  <span>Bisnis</span></a>
                        <ul class="child-list">
                            <li class="{{ set_active('backend/business/add') }}"><a href="{{ url('/backend/business/add') }}"> Tambah Bisnis</a></li>
                            <li class="{{ set_active('backend/business') }}"><a href="{{ url('/backend/business') }}"> Daftar Bisnis</a></li>
                            <li class="{{ set_active('backend/business/map') }}"><a href="{{ url('/backend/business/map') }}"> Peta Bisnis</a></li>
                        </ul>
                    </li>
                    <li class="menu-list {{ set_active('backend/product/category*', 'nav-active') }}">
                        <a href=""><i class="fa fa-tags"></i>  <span>Kategori Produk</span></a>
                        <ul class="child-list">
                            <li class="{{ set_active('backend/product/category/add') }}"><a href="{{ url('/backend/product/category/add') }}"> Tambah Kategori Produk</a></li>
                            <li class="{{ set_active('backend/product/category') }}"><a href="{{ url('/backend/product/category') }}"> Daftar Kategori Produk</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-list {{ set_active('backend/kecamatan*', 'nav-active') }}">
                        <a href=""><i class="fa fa-shield"></i>  <span>Kecamatan</span></a>
                        <ul class="child-list">
                    ...
                    <li class="menu-list {{ set_active('backend/user*', 'nav-active') }}">
                        ...
                        <ul class="child-list">
                            <li class="{{ set_active('backend/user/add') }}"><a href="{{ url('/backend/user/add') }}"> Tambah User</a></li>
                            <li class="{{ set_active('backend/user') }}"><a href="{{ url('/backend/user') }}"> Daftar User</a></li>
                        </ul>
                    </li>
                    <li class="menu-list {{ set_active('backend/permission*', 'nav-active') }}">
                        <a href=""><i class="fa fa-check"></i>  <span>Permission</span></a>
                        <ul class="child-list">
                            <li class="{{ set_active('backend/permission/add') }}"><a href="{{ url('/backend/permission/add') }}"> Tambah Permission</a></li>
                            <li class="{{ set_active('backend/permission') }}"><a href="{{ url('/backend/permission') }}"> Daftar Permission</a></li>
                        </ul>
                    </li>
                    <li class="menu-list {{ set_active('backend/role*', 'nav-active') }}">
                        <a href=""><i class="fa fa-star"></i>  <span>Role</span></a>
                        <ul class="child-list">
                            <li class="{{ set_active('backend/role/add') }}"><a href="{{ url('/backend/role/add') }}"> Tambah Role</a></li>
