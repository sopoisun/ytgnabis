...
<head>
    ...
    <!--switchery-->
    <link href="{{ url('/assets/'.config('app.backend_template')) }}/js/switchery/switchery.min.css" rel="stylesheet" type="text/css" media="screen" />
    ...
    <section>
        ...
        <div class="sidebar-left">
            ...
            <div class="logo dark-logo-bg visible-xs-* visible-sm-*">
                <a href="index.html">
                    <img src="{{ url('/assets/'.config('app.backend_template')) }}/img/logo-icon.png" alt="">
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="{{ url('/assets/'.config('app.backend_template')) }}/img/mega-menu/mega_icon1.png" alt="" />
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="{{ url('/assets/'.config('app.backend_template')) }}/img/mega-menu/mega_icon2.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Amaging Dashboard</span>
                                                                <span class="d-desk">Build with BS3</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="{{ url('/assets/'.config('app.backend_template')) }}/img/mega-menu/mega_icon3.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">3500+ Satisfied Client</span>
                                                                <span class="d-desk">Max 5 star rating</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="{{ url('/assets/'.config('app.backend_template')) }}/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
                        ...
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                            ...
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> German </span><img src="{{ url('/assets/'.config('app.backend_template')) }}/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Italian </span> <img src="{{ url('/assets/'.config('app.backend_template')) }}/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> French </span> <img src="{{ url('/assets/'.config('app.backend_template')) }}/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Spanish </span> <img src="{{ url('/assets/'.config('app.backend_template')) }}/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Russian </span> <img src="{{ url('/assets/'.config('app.backend_template')) }}/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="online-chat-container">
                        ...
                        <ul class="team-list chat-list-side">
                            <li>
                                ...
                                <img class="circle" src="{{ url('/assets/'.config('app.backend_template')) }}/img/img2.jpg" alt="">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="{{ url('/assets/'.config('app.backend_template')) }}/img/img3.jpg" alt="">
                                <i class="online dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="{{ url('/assets/'.config('app.backend_template')) }}/img/img1.jpg" alt="">
                                <i class="away dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
...
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery-1.10.2.min.js"></script>

<!--jquery-ui-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>

<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery-migrate.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/bootstrap.min.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/modernizr.min.js"></script>

<!--Nice Scroll-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery.nicescroll.js" type="text/javascript"></script>

<!--right slidebar-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/slidebars.min.js"></script>

<!--switchery-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/switchery/switchery.min.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/switchery/switchery-init.js"></script>

<!--flot chart -->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/flot-spline.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.resize.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.pie.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.selection.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.stack.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/flot-chart/jquery.flot.crosshair.js"></script>


<!--earning chart init-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/earning-chart-init.js"></script>


<!--Sparkline Chart-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/sparkline/jquery.sparkline.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/sparkline/sparkline-init.js"></script>

<!--easy pie chart-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/easy-pie-chart.js"></script>


<!--vectormap-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/vector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/vector-map/jquery-jvectormap-world-mill-en.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/dashboard-vmap-init.js"></script>

<!--Icheck-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/icheck/skins/icheck.min.js"></script>
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/todo-init.js"></script>

<!--jquery countTo-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/jquery-countTo/jquery.countTo.js"  type="text/javascript"></script>

<!--owl carousel-->
<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/owl.carousel.js"></script>


<!--common scripts for all pages-->

<script src="{{ url('/assets/'.config('app.backend_template')) }}/js/scripts.js"></script>
