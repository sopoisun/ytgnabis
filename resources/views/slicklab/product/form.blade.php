...
<div class="form-group @if($errors->has('business_id')) has-error @endif">
    ...
    <div class="col-lg-9">
        {{ Form::select('business_id', $businesses, null, ['id' => 'business_id', 'class' => 'form-control']) }}
...
<div class="form-group @if($errors->has('product_category_id')) has-error @endif">
    ...
    <div class="col-lg-9">
        {{ Form::select('product_category_id', $categories, null, ['id' => 'product_category_id', 'class' => 'form-control']) }}
...
<div class="form-group @if($errors->has('about')) has-error @endif">
    <label for="seo[keywords]" class="col-lg-3 col-sm-3 control-label">Product Desc</label>
    <div class="col-lg-9">
